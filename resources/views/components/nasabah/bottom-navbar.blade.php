...
<nav id="bottomNavbar" class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50 transition-transform duration-300">
    <div class="w-full px-2">
        <div class="flex items-center justify-around py-2">
            ...
            <!-- Tabungan -->
            <a href="{{ route('nasabah.tabungan.index') }}" class="flex flex-col items-center justify-center space-y-1 px-3 py-2 rounded-lg transition-colors {{ str_contains($currentRoute, 'tabungan') ? 'text-primary' : 'text-gray-600 hover:text-primary' }}">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
