        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-1 sm:space-x-3 shrink-0">
                ...
                <div class="relative group">
                    <a href="{{ route('nasabah.notifications.index') }}" class="relative inline-flex p-2 text-gray-500 hover:text-[#674c1d] transition-colors rounded-xl hover:bg-amber-50">
                    ...
                    <div class="absolute right-[-40px] sm:right-0 mt-2 w-[260px] sm:w-[320px] bg-white rounded-3xl shadow-2xl border border-gray-100 py-2 sm:py-3 z-[100] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 -translate-y-2 origin-top-right">
                ...
                <!-- Profile Dropdown -->
                <div class="relative group">
                    <button class="p-2 text-gray-500 hover:text-[#674c1d] transition-colors focus:outline-none rounded-xl hover:bg-amber-50">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
