                        ...
                        @foreach($columns as $key => $column)
                            <td class="px-4 py-3 text-sm">
                                @if($key === 'jumlah' && isset($row->{$key}))
                                    <div class="flex items-center gap-2">
                                        <div class="w-8 h-8 bg-gradient-to-br from-[#d4af37]/20 to-[#8b6f2f]/20 rounded-lg flex items-center justify-center">
                                ...
                                @elseif($key === 'tanggal' && isset($row->{$key}))
                                    <div class="flex items-center gap-2">
                                        <div class="w-8 h-8 bg-gradient-to-br from-[#8b6f2f]/20 to-[#674c1d]/20 rounded-lg flex items-center justify-center">
                                ...
                                @elseif($key === 'nominal' && isset($row->{$key}))
                                    <div class="flex items-center gap-2">
                                        <div class="w-8 h-8 bg-gradient-to-br from-[#d4af37]/20 to-[#674c1d]/20 rounded-lg flex items-center justify-center">
                ...
                <tr>
                    <td colspan="{{ count($columns) }}" class="px-4 py-12 text-center">
                        <div class="flex flex-col items-center gap-3">
                            <div class="w-16 h-16 bg-gradient-to-br from-[#674c1d]/10 to-[#8b6f2f]/10 rounded-full flex items-center justify-center">
