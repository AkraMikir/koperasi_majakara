...
<body class="bg-[#faf9f6] text-gray-800 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="{{ route('welcome') }}#beranda"
                        class="text-gray-700 hover:text-primary transition">Beranda</a>
                    <a href="{{ route('landing.layanan') }}"
                        class="text-gray-700 hover:text-primary transition">Layanan</a>
                    <a href="{{ route('landing.keuntungan') }}"
                        class="text-primary font-semibold border-b-2 border-primary">Keuntungan</a>
                ...
                <div class="hidden md:flex items-center space-x-4">
                    ...
                    @endphp
                    <a href="{{ $dashboardUrl }}"
                        class="px-6 py-2.5 bg-primary text-white rounded-lg hover:bg-primary-dark transition-all shadow-md font-medium flex items-center space-x-2 group">
                    ...
                    @else
                    <a href="{{ route('login') }}"
                        class="px-5 py-2.5 text-primary border border-primary rounded-lg hover:bg-primary hover:text-white transition font-medium">Login</a>
                    @if (Route::has('register'))
                    <a href="{{ route('register') }}"
                        class="px-6 py-2.5 bg-linear-to-r from-[#674c1d] to-[#8b6f2f] text-white rounded-lg hover:from-[#4a3514] hover:to-[#674c1d] transition shadow-md font-medium">Register</a>
                    @endif
                    @endif
                    @endif
                </div>
    ...
    <section class="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        style="background: linear-gradient(135deg, #faf9f6 0%, #ffffff 100%);">
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="text-center mb-16">
                ...
                <h1 class="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-primary mb-6">
                    ...
                    <span
                        style="background: linear-gradient(135deg, #d4af37 0%, #f4d03f 100%); -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;">Koperasi
                        Majakara</span>
                </h1>
                <p class="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
                    Mengapa ribuan anggota mempercayakan kebutuhan keuangan mereka kepada kami? Temukan berbagai
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                <div class="bg-white rounded-2xl p-8 shadow-lg text-center card-hover border border-gray-100">
                    <div class="text-5xl md:text-6xl font-bold mb-2"
                        style="background: linear-gradient(135deg, #674c1d 0%, #8b6f2f 100%); -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;">
                        100%</div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg text-center card-hover border border-gray-100">
                    <div class="text-5xl md:text-6xl font-bold mb-2"
                        style="background: linear-gradient(135deg, #d4af37 0%, #f4d03f 100%); -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;">
                        24/7</div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg text-center card-hover border border-gray-100">
                    <div class="text-5xl md:text-6xl font-bold mb-2"
                        style="background: linear-gradient(135deg, #8b6f2f 0%, #d4af37 100%); -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;">
                        10K+</div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg text-center card-hover border border-gray-100">
                    <div class="text-5xl md:text-6xl font-bold mb-2"
                        style="background: linear-gradient(135deg, #674c1d 0%, #d4af37 100%); -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;">
                        98%</div>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                        Keamanan dana Anda adalah prioritas utama kami. Sistem keamanan berlapis dan telah terpercaya
                        oleh ribuan anggota selama bertahun-tahun.
                    </p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-4 p-4 bg-green-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm">Semua data dienkripsi dengan standar keamanan tinggi
                                    SSL/TLS</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4 p-4 bg-blue-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm">PIN + OTP untuk transaksi penting, approval admin untuk
                                    setiap pengajuan</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4 p-4 bg-purple-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm">Sistem dipantau terus-menerus untuk mencegah aktivitas
                                    mencurigakan</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="order-2 lg:order-1">
                    <div class="bg-white rounded-3xl p-10 shadow-2xl">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center space-x-4">
                                <div class="shrink-0">
                                    <div
                                        class="w-16 h-16 bg-linear-to-br from-[#674c1d] to-[#8b6f2f] rounded-2xl flex items-center justify-center">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="shrink-0">
                                    <div
                                        class="w-16 h-16 bg-linear-to-br from-[#8b6f2f] to-[#d4af37] rounded-2xl flex items-center justify-center">
                                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="text-right">
                                    <div class="text-3xl font-bold text-[#8b6f2f]">
                                        < 24j</div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="shrink-0">
                                        <div
                                            class="w-16 h-16 bg-linear-to-br from-[#d4af37] to-[#8b6f2f] rounded-2xl flex items-center justify-center">
                                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="order-1 lg:order-2">
                        ...
                        <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                            Tidak perlu antri lama atau datang ke kantor. Semua proses dapat dilakukan secara online
                            dengan sistem yang terintegrasi dan otomatis.
                        </p>

                        <div class="grid grid-cols-2 gap-4 mb-8">
                            <div class="bg-white rounded-xl p-6 shadow-lg text-center border border-gray-100">
                                <div class="text-4xl font-bold text-[#674c1d] mb-2">1 Menit</div>
    ...
    <section class="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                <!-- Tabungan Comparison -->
                <div
                    class="bg-linear-to-br from-[#674c1d] to-[#8b6f2f] rounded-3xl p-8 text-white shadow-2xl card-hover">
                ...
                <!-- Deposito Comparison -->
                <div
                    class="bg-linear-to-br from-[#d4af37] to-[#8b6f2f] rounded-3xl p-8 text-white shadow-2xl card-hover">
                    <div class="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Pinjaman Comparison -->
                <div
                    class="bg-linear-to-br from-[#8b6f2f] to-[#674c1d] rounded-3xl p-8 text-white shadow-2xl card-hover">
                    <div class="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M13 10V3L4 14h7v7l9-11h-7z"></path>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                        Akses seluruh layanan kapan saja, di mana saja melalui platform digital kami yang modern dan
                        mudah digunakan.
                    </p>
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex items-center space-x-4">
                            <div
                                class="w-14 h-14 bg-linear-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shrink-0">
                        ...
                        <div class="flex items-center space-x-4">
                            <div
                                class="w-14 h-14 bg-linear-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center shrink-0">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z">
                                    </path>
                        ...
                        <div class="flex items-center space-x-4">
                            <div
                                class="w-14 h-14 bg-linear-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center shrink-0">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9">
                                    </path>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 card-hover">
                    <div
                        class="w-16 h-16 bg-linear-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mb-6 benefit-icon">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                            </path>
                    ...
                    <p class="text-gray-600 leading-relaxed">Semua biaya transparan dan dijelaskan di awal. Tidak ada
                        biaya mengejutkan di kemudian hari.</p>
                </div>

                <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 card-hover">
                    <div
                        class="w-16 h-16 bg-linear-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 benefit-icon">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-gray-600 leading-relaxed">Tim kami siap membantu menjawab pertanyaan dan
                        menyelesaikan masalah Anda dengan cepat.</p>
                </div>

                <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 card-hover">
                    <div
                        class="w-16 h-16 bg-linear-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 benefit-icon">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-gray-600 leading-relaxed">Setor, tarik, ajukan pinjaman kapan saja. Pilih metode yang
                        paling nyaman untuk Anda.</p>
                </div>

                <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 card-hover">
                    <div
                        class="w-16 h-16 bg-linear-to-br from-yellow-500 to-yellow-600 rounded-2xl flex items-center justify-center mb-6 benefit-icon">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-gray-600 leading-relaxed">Bunga tabungan dihitung harian, deposito dengan return
                        tinggi, pinjaman dengan bunga ringan.</p>
                </div>

                <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 card-hover">
                    <div
                        class="w-16 h-16 bg-linear-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center mb-6 benefit-icon">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z">
                            </path>
                    ...
                    <p class="text-gray-600 leading-relaxed">Koperasi resmi yang terdaftar dan diawasi oleh pemerintah
                        untuk keamanan Anda.</p>
                </div>

                <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 card-hover">
                    <div
                        class="w-16 h-16 bg-linear-to-br from-indigo-500 to-indigo-600 rounded-2xl flex items-center justify-center mb-6 benefit-icon">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    ...
                    <p class="text-gray-600 leading-relaxed">Pengajuan hanya 5 menit, approval dalam 1 hari. Tidak perlu
                        menunggu lama.</p>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        style="background: linear-gradient(135deg, #4a3514 0%, #674c1d 50%, #8b6f2f 100%);">
        <div class="absolute inset-0 opacity-10">
            <div class="absolute top-0 left-0 w-full h-full"
                style="background-image: radial-gradient(circle, #d4af37 1px, transparent 1px); background-size: 30px 30px;">
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p class="text-xl text-white/90 mb-10">
                Bergabunglah dengan Koperasi Majakara dan nikmati berbagai keuntungan yang telah dirasakan ribuan
                anggota
            </p>
            @if (!auth()->check())
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('register') }}"
                    class="px-10 py-5 bg-white text-primary rounded-xl font-bold hover:bg-gray-100 transition shadow-2xl hover:shadow-3xl text-lg">
                    Daftar Sekarang - Gratis!
                </a>
                <a href="{{ route('login') }}"
                    class="px-10 py-5 border-2 border-white text-white rounded-xl font-bold hover:bg-white/10 transition text-lg">
                    Sudah Punya Akun?
                </a>
            </div>
            @else
            ...
            @endphp
            <a href="{{ $dashboardUrl }}"
                class="inline-block px-10 py-5 bg-white text-primary rounded-xl font-bold hover:bg-gray-100 transition shadow-2xl text-lg">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid md:grid-cols-4 gap-8 mb-12">
                <div class="md:col-span-1">
                    ...
                    <p class="text-white/80 text-sm">Solusi keuangan terpercaya untuk mewujudkan impian finansial Anda.
                    </p>
                </div>
                <div>
                    <h3 class="font-bold text-lg mb-4">Layanan</h3>
                    <ul class="space-y-2 text-sm text-white/80">
                        <li><a href="{{ route('landing.layanan') }}" class="hover:text-white transition">Tabungan</a>
                        </li>
                        <li><a href="{{ route('landing.layanan') }}" class="hover:text-white transition">Pinjaman</a>
                        </li>
                        <li><a href="{{ route('landing.layanan') }}" class="hover:text-white transition">Deposito</a>
                        </li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-white/80">
                        <li><a href="{{ route('landing.keuntungan') }}"
                                class="hover:text-white transition">Keuntungan</a></li>
                        <li><a href="{{ route('landing.testimoni') }}" class="hover:text-white transition">Testimoni</a>
                        </li>
