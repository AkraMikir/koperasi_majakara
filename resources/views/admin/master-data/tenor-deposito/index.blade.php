...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        @canCrudMasterData
        <a href="{{ route('admin.master-data.tenor-deposito.create') }}" class="px-4 py-2 bg-gradient-to-r from-[#674c1d] to-[#8b6f2f] text-white rounded-lg hover:from-[#4a3514] hover:to-[#674c1d] transition-all shadow-md text-sm font-medium">
            + Tambah Data
        </a>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @else
                            <span class="px-3 py-1 rounded-full text-xs font-medium {{ $item->aktif ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700' }}">
                                {{ $item->aktif ? 'Aktif' : 'Nonaktif' }}
                            </span>
                            @endcanCrudMasterData
                        </td>
