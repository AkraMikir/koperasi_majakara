...
@section('title', 'Master Jenis Fitur')
    ...
    <div class="flex items-center justify-between">
        <div>
            <div class="flex items-center space-x-2 text-sm text-gray-600 mb-2">
                ...
                <span>/</span>
                <span class="text-gray-900 font-medium">Jenis Fitur</span>
            </div>
            <h1 class="text-3xl font-bold text-gray-900 font-display">Master Jenis Fitur</h1>
            <p class="text-gray-600 mt-1">Daftar fitur aktif sistem Koperasi Majakara</p>
        </div>
    </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase">Nama Fitur</th>
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase">Deskripsi / Format ID</th>
