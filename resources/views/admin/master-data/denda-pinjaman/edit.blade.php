...
@section('title', 'Edit Master Denda Pinjaman')
...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-3xl font-bold text-gray-900 font-display">Edit Master Denda Pinjaman</h1>
        </div>
    </div>

    <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
        <form action="{{ route('admin.master-data.denda-pinjaman.update', $data->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
