        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
            <form action="{{ route('admin.master-data.item-gadai.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <select name="kategori_id" id="kategori_id"
                            ...
                            @foreach($kategoris as $kat)
                                <option value="{{ $kat->id }}" data-kode="{{ $kat->kode_kategori }}"
                                    ...
                                    data-inap-persen="{{ $kat->rate_inap_persen }}" {{ old('kategori_id') == $kat->id ? 'selected' : '' }}>{{ $kat->nama_kategori }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="head_1" id="head_1"
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#674c1d] focus:border-transparent transition-all font-bold text-gray-700"
                            value="{{ old('head_1') }}" required placeholder="Contoh: Honda Beat, Emas Antam 10gr">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="head_2" id="head_2"
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#674c1d] focus:border-transparent transition-all font-bold text-gray-700"
                            value="{{ old('head_2') }}" placeholder="Contoh: Tahun 2022, 24 Karat">
                    </div>
                    ...
                    <div
                        ...
                        <div class="col-span-2 pt-2 border-t border-emerald-100 mt-2">
                            <div id="inap_preset_container" class="hidden mb-4">
                                ...
                                <p id="inap_preset_desc" class="text-[9px] text-amber-600 mt-1 italic hidden"></p>
                            </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-[10px] text-gray-400 mt-2">Gunakan foto transparan atau bersih untuk katalog nasabah
                            (Max 2MB).</p>
                    </div>
                </div>
                ...
                <div class="flex justify-end items-center gap-3 pt-6 border-t border-gray-100">
                    <button type="reset"
                        class="px-6 py-3 text-gray-500 font-bold hover:text-gray-700 transition-all">Reset</button>
                    <button type="submit"
