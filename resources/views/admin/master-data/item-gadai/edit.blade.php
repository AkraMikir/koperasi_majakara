...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between gap-4 mb-8">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi untuk: <span class="text-[#674c1d] font-bold">{{ $data->nama_item }}</span></p>
        </div>
    ...
    <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
        <form action="{{ route('admin.master-data.item-gadai.update', $data->id) }}" method="POST" enctype="multipart/form-data" class="p-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div class="md:col-span-2">
                    ...
                    <select name="kategori_id" id="kategori_id" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#674c1d] focus:border-transparent transition-all font-bold text-gray-700" required>
                        ...
                        @foreach($kategoris as $kat)
                            <option value="{{ $kat->id }}" {{ (old('kategori_id') ?? $data->kategori_id) == $kat->id ? 'selected' : '' }}>{{ $kat->nama_kategori }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="head_1" id="head_1" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#674c1d] focus:border-transparent transition-all font-bold text-gray-700" value="{{ old('head_1') ?? $data->head_1 }}" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="head_2" id="head_2" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#674c1d] focus:border-transparent transition-all font-bold text-gray-700" value="{{ old('head_2') ?? $data->head_2 }}">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="nominal_real" id="nominal_real" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#674c1d] focus:border-transparent transition-all font-bold text-gray-700" value="{{ old('nominal_real') ?? $data->nominal_real }}" min="0" required>
                </div>
                ...
                <div>
                    ...
                    <select name="is_active" id="is_active" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#674c1d] focus:border-transparent transition-all font-bold text-gray-700" required>
                        ...
                        <option value="0" {{ (old('is_active', $data->is_active)) == 0 ? 'selected' : '' }}>Non-Aktif</option>
                    </select>
                </div>
                ...
                <div class="bg-emerald-50/50 p-4 rounded-2xl border border-emerald-100 md:col-span-2 grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="nominal_low" id="nominal_low" class="w-full px-3 py-2 bg-gray-100 border border-emerald-100 rounded-lg focus:ring-2 focus:ring-emerald-500 transition-all font-bold text-gray-500 text-sm" value="{{ old('nominal_low') ?? $data->nominal_low }}" readonly>
                    </div>
                    <div>
                        ...
                        <input type="number" name="bunga_low" id="bunga_low" step="0.01" class="w-full px-3 py-2 bg-white border border-emerald-100 rounded-lg focus:ring-2 focus:ring-emerald-500 transition-all font-bold text-gray-700 text-sm" value="{{ old('bunga_low') ?? $data->bunga_low }}" min="0" required placeholder="Contoh: 40">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="nominal_high" id="nominal_high" class="w-full px-3 py-2 bg-gray-100 border border-emerald-100 rounded-lg focus:ring-2 focus:ring-emerald-500 transition-all font-bold text-gray-500 text-sm" value="{{ old('nominal_high') ?? $data->nominal_high }}" readonly>
                    </div>
                    <div>
                        ...
                        <input type="number" name="bunga_high" id="bunga_high" step="0.01" class="w-full px-3 py-2 bg-white border border-emerald-100 rounded-lg focus:ring-2 focus:ring-emerald-500 transition-all font-bold text-gray-700 text-sm" value="{{ old('bunga_high') ?? $data->bunga_high }}" min="0" required placeholder="Contoh: 60">
                    </div>
                    ...
                    <div class="col-span-2 pt-2 border-t border-emerald-100 mt-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="nominal_inap" id="nominal_inap" class="w-full pl-8 px-3 py-2 bg-white border border-emerald-100 rounded-lg focus:ring-2 focus:ring-emerald-500 transition-all font-bold text-gray-700 text-sm" value="{{ old('nominal_inap', $data->nominal_inap) }}" min="0">
                        </div>
