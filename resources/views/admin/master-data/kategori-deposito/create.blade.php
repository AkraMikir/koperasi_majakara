...
@section('title', 'Tambah Kategori Deposito')
...
<div class="space-y-6">
    ...
    <div class="flex items-center space-x-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-xs">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 font-display">Tambah Kategori Deposito</h1>
            <p class="text-sm text-gray-500 mt-1">Buat master data kategori baru.</p>
        </div>
    </div>

    <!-- Form Section -->
    <div class="bg-white rounded-2xl border border-gray-100 shadow-xs overflow-hidden">
        <form action="{{ route('admin.master-data.kategori-deposito.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="text" name="nama_kategori" id="nama_kategori" required
                        ...
                        placeholder="Contoh: Promo Lebaran, Flash Sale">
                    @error('nama_kategori')
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <textarea name="keterangan" id="keterangan" rows="3"
                        class="w-full rounded-xl border-gray-300 focus:border-[#8b6f2f] focus:ring focus:ring-[#8b6f2f]/20 transition-all placeholder-gray-400"
                        placeholder="Tambahkan informasi khusus mengenai kategori ini">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
