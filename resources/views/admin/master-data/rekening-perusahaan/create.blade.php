    ...
    <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
        <form action="{{ route('admin.master-data.rekening-perusahaan.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="nama" value="{{ old('nama') }}" required class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#8b6f2f] focus:ring-2 focus:ring-[#8b6f2f]/20 outline-none" placeholder="Contoh: BCA">
            ...
            <div>
                ...
                <input type="text" name="bank" value="{{ old('bank') }}" required class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#8b6f2f] focus:ring-2 focus:ring-[#8b6f2f]/20 outline-none" placeholder="Contoh: BCA">
