...
<div class="space-y-8 pb-12 animate-fade-in">
    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            ...
            {{-- Tujuan Pinjaman --}}
            <a href="{{ route('admin.master-data.tujuan-pinjaman.index') }}"
                class="group bg-white rounded-2xl border border-gray-100 shadow-sm p-6 hover:shadow-md hover:border-emerald-600/30 transition-all duration-200 flex flex-col justify-between h-full">
                <div>
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="px-2.5 py-1 bg-emerald-50 text-emerald-700 rounded-lg text-xs font-bold border border-emerald-100">
                            {{ $stats['total_tujuan_pinjaman'] }} tujuan
                        </span>
                    </div>
                    <h3 class="text-base font-bold text-gray-900 mb-1.5 group-hover:text-emerald-700 transition-colors">Tujuan Pinjaman</h3>
                    <p class="text-xs text-gray-500 leading-relaxed">Kelola daftar tujuan pengajuan pinjaman (misal: Modal Usaha, Renovasi Rumah) untuk dropdown formulir.</p>
                </div>
                <div class="flex items-center justify-end mt-4 pt-3 border-t border-gray-50">
                    <span class="text-xs font-semibold text-emerald-700 group-hover:underline flex items-center gap-1">
                        Kelola
                        <svg class="w-3.5 h-3.5 transform group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path>
                        </svg>
    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            ...
            <a href="{{ route('admin.master-data.bank-regis.index') }}"
                class="group bg-white rounded-2xl border border-gray-100 shadow-sm p-6 hover:shadow-md hover:border-violet-500/30 transition-all duration-200 flex flex-col justify-between h-full">
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-11 h-11 bg-gradient-to-br from-violet-500 to-violet-600 rounded-xl flex items-center justify-center text-white shadow-sm transition-transform group-hover:scale-110">
                            <svg class="w-5.5 h-5.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                        </div>
                        <span class="px-2.5 py-1 bg-violet-50 text-violet-600 rounded-lg text-xs font-bold border border-violet-100">
                            {{ $stats['total_bank_regis'] ?? 0 }} bank
                        </span>
                    </div>
                    <h3 class="text-base font-bold text-gray-900 mb-1.5 group-hover:text-violet-600 transition-colors">Bank Registrasi</h3>
                    <p class="text-xs text-gray-500 leading-relaxed">Daftar master bank yang digunakan untuk proses registrasi dan identifikasi rekening nasabah.</p>
                </div>
                <div class="flex items-center justify-end mt-4 pt-3 border-t border-gray-50">
                    <span class="text-xs font-semibold text-violet-600 group-hover:underline flex items-center gap-1">
                        Kelola
                        <svg class="w-3.5 h-3.5 transform group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path>
                        </svg>
