                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                ...
                                <p class="font-bold text-gray-900 text-lg">Rp
                                    {{ number_format($janjiTemu->nominal ?? 0, 0, ',', '.') }}
                                </p>
                            </div>
                        </div>
                        ...
                        @if($janjiTemu->pengajuan)
                            <div class="p-4 bg-blue-50 rounded-xl border border-blue-100">
                                ...
                                <p class="font-medium text-gray-900">Durasi {{ $janjiTemu->pengajuan->durasi }} bulan, Jenis
                                    {{ ucfirst($janjiTemu->pengajuan->jenis ?? 'bulanan') }}
                                </p>
                            </div>
                        @endif
            ...
            <div class="space-y-6 lg:sticky lg:top-6 lg:self-start">
                ...
                <div class="bg-[#674c1d] rounded-2xl shadow-lg p-6 text-white relative overflow-hidden"
                    ...
                    <div class="relative z-10">
                        ...
                        <span
                            class="inline-flex px-4 py-1.5 rounded-full {{ str_replace('text-', 'text-white bg-opacity-20 border border-white/30 ', $janjiTemu->status_display['class']) }} font-semibold text-sm">
                        ...
                        @if($janjiTemu->status == '1')
                            ...
                            <div x-show="openCancel"
                                ...
                                <div class="bg-white rounded-2xl shadow-xl max-w-md w-full p-6"
                                    ...
                                    <p class="text-sm text-gray-600 mb-6">Harap berikan alasan pembatalan janji temu pinjaman
                                        ini.</p>

                                    <form action="{{ route('admin.janji-temu.cancel-pinjaman', $janjiTemu->id) }}"
                                        method="POST">
                                        @csrf
                                        <div class="mb-6">
                                        ...
                                        <div class="flex gap-3">
                                            <button type="button" @click="openCancel = false"
                                                class="flex-1 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium">Batal</button>
                                            <button type="submit"
                                                class="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 font-medium">Konfirmasi
                                                Batal</button>
                                        </div>
                                    </form>
                                </div>
