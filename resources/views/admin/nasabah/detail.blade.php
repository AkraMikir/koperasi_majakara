...
<div class="space-y-6">
    ...
    <!-- Profile Header -->
    <div class="bg-gradient-to-br from-[#674c1d] via-[#8b6f2f] to-[#d4af37] rounded-2xl shadow-2xl p-8 border-2 border-[#d4af37]/30">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-[#674c1d] to-[#8b6f2f] px-6 py-4">
        ...
        <form id="form-reset-pin" action="{{ route('admin.nasabah.reset-pin', $nasabah->id) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <div class="flex gap-3">
                    ...
                    <button type="button" onclick="generateRandomPinAdmin()" class="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-blue-800 transition-all shadow-md flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex gap-3">
                <button type="submit" onclick="return confirm('Yakin reset PIN nasabah ini? PIN lama akan diganti dengan PIN baru.')" 
                    class="flex-1 px-6 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.01] flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://wa.me/62{{ ltrim($nasabah->user->nomor_hp, '0') }}" target="_blank"
                    class="px-6 py-4 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2">
