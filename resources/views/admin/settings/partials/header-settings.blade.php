<form action="{{ route('admin.settings.struk.update-header') }}" method="POST" class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="nama_koperasi" value="{{ $settings->nama_koperasi }}" x-model="nama_koperasi" required
        ...
        <div>
            ...
            <input type="text" name="no_telp" value="{{ $settings->no_telp }}" x-model="no_telp" required
                class="w-full rounded-xl border-gray-300 focus:border-[#674c1d] focus:ring focus:ring-[#674c1d]/20 transition-shadow">
        </div>
    </div>
    <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Alamat Koperasi</label>
        <textarea name="alamat_koperasi" rows="3" x-model="alamat_koperasi" required
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="email" name="email" value="{{ $settings->email }}" x-model="email" required
                class="w-full rounded-xl border-gray-300 focus:border-[#674c1d] focus:ring focus:ring-[#674c1d]/20 transition-shadow">
        </div>
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Website</label>
            <input type="url" name="website" value="{{ $settings->website }}" x-model="website"
                class="w-full rounded-xl border-gray-300 focus:border-[#674c1d] focus:ring focus:ring-[#674c1d]/20 transition-shadow">
        </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="nama_pt" value="{{ $settings->nama_pt }}" x-model="nama_pt" required
                class="w-full rounded-xl border-gray-300 focus:border-[#674c1d] focus:ring focus:ring-[#674c1d]/20 transition-shadow">
        </div>
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Format No. Struk</label>
            <input type="text" name="format_no_struk" value="{{ $settings->format_no_struk }}" x-model="format_no_struk" required
                class="w-full rounded-xl border-gray-300 focus:border-[#674c1d] focus:ring focus:ring-[#674c1d]/20 transition-shadow">
