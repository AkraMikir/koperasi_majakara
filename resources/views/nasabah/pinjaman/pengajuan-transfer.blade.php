                ...
                <div class="mb-6 p-6 bg-linear-to-br from-[#8b6f2f]/10 to-[#d4af37]/10 rounded-xl border border-[#8b6f2f]/20">
                    ...
                    <div class="space-y-3" id="estimasiSection">
                        ...
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0 border-b border-gray-100/50 pb-2 last:border-0 last:pb-0">
                            ...
                            <span class="font-semibold text-gray-900 whitespace-nowrap text-right sm:text-left" id="estimasiBunga">-</span>
                        </div>
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0 border-b border-gray-100/50 pb-2 last:border-0 last:pb-0">
                            <span class="text-sm text-gray-600">Yang Diterima:</span>
                            <span class="font-semibold text-green-600 whitespace-nowrap text-right sm:text-left" id="estimasiDiterima">Rp 0</span>
                        </div>
