...
@section('content')
    <div class="w-full pb-20 px-4 lg:px-8 max-w-[1600px] mx-auto animate-fade-in" x-data="{ showBalance: false }">
        ...
        <div class="mb-6 bg-amber-50 border border-amber-200 rounded-3xl p-5 md:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm animate-fade-in relative z-20">
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-base font-bold text-amber-900 font-display">Akun Sedang Diverifikasi</h3>
                    <p class="text-xs text-amber-700 leading-relaxed mt-1">
                        Pendaftaran Anda sedang ditinjau oleh Admin Utama. Selama masa verifikasi, akses ke fitur tabungan, pinjaman, deposito, dan gadai dikunci sementara. Harap menunggu pemberitahuan selanjutnya.
                    </p>
                </div>
            </div>
            <div class="shrink-0 w-full md:w-auto">
                <a href="{{ route('nasabah.profile') }}" class="inline-flex items-center justify-center gap-1.5 text-xs font-bold text-amber-800 hover:text-amber-900 bg-white hover:bg-amber-100/50 px-4 py-2.5 rounded-xl border border-amber-200 shadow-sm transition-all w-full md:w-auto cursor-pointer">
                    Cek Detail Profil
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
            ...
            <div class="lg:col-span-5 bg-white rounded-[2rem] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('nasabah.riwayat-transaksi') }}" class="text-[10px] font-bold text-majakara-dark-gold hover:text-majakara-brown uppercase tracking-wider flex items-center gap-1 group">
                        Lihat Semua
