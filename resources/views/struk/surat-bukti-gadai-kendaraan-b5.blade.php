...
<head>
    <meta charset="UTF-8">
    <title>Surat Bukti Gadai Kendaraan - {{ $data['slot_kode'] }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="page">
        ...
        <div class="banner">
            SURAT BUKTI GADAI BARANG KENDARAAN
        </div>
            ...
            <tr>
                ...
                <td style="width: 31%; vertical-align: top; border: none;">
                    <table class="detail-table" style="width: 100%;">
                        ...
                        <tr>
                            <td class="label">No Mesin/Rangka</td>
                            <td class="value">: {{ $data['no_mesin_rangka'] }}</td>
                        </tr>
                        <tr>
