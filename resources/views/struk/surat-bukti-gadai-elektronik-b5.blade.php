...
<body>
    ...
    <div class="page">
        ...
        <div class="perjanjian-section">
            @if(!empty($settings->syarat_ketentuan_gadai_elektronik))
            <div class="perjanjian-text" style="white-space: pre-line;">{!! str_replace(
                'MAJAKARA',
                '<strong>MAJAKARA</strong>',
                e($settings->syarat_ketentuan_gadai_elektronik)
            ) !!}</div>
            @else
        ...
        <table class="footer-table">
            <tr>
                <td style="width: 25%;">
                    <div class="info-box" style="white-space: pre-line;">@if(!empty($settings->info_box_gadai_elektronik)){!! str_replace('MAJAKARA', '<strong>MAJAKARA</strong>', e($settings->info_box_gadai_elektronik)) !!}@else PINJAMAN BISA DIANGSUR HARI BESAR DAN HARI MINGGU TETAP BUKA.
                    ...
                    <table style="width: 100%; font-size: 8.5px; font-weight: bold;">
                        <tr>
                            <td class="signature-area" style="width: 33%;">
                                ...
                                <div class="signature-space" style="padding-top: 5px;"></div>
                                ( ................................. )
                            </td>
                            <td class="signature-area" style="width: 33%;">
                                Yang Memberi Kuasa
