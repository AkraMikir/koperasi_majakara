...
<body class="bg-[#faf9f6] text-gray-800 antialiased">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center space-x-3">
                    <img src="{{ asset('images/logo/logo_coklat.png') }}" alt="Logo Kospin Majakara"
                        class="h-16 w-auto object-contain"
                        style="mix-blend-mode: multiply; filter: brightness(1.1) contrast(1.2);">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('landing.layanan') }}"
                        class="text-gray-700 hover:text-primary transition">Layanan</a>
                    <a href="{{ route('landing.keuntungan') }}"
                        class="text-gray-700 hover:text-primary transition">Keuntungan</a>
                    <a href="{{ route('landing.testimoni') }}"
                        class="text-gray-700 hover:text-primary transition">Testimoni</a>
                ...
                <div class="hidden md:flex items-center space-x-4">
                    ...
                    @endphp
                    <a href="{{ $dashboardUrl }}"
                        class="px-6 py-2.5 bg-primary text-white rounded-lg hover:bg-primary-dark transition-all shadow-md hover:shadow-lg font-medium flex items-center space-x-2 group">
                    ...
                    @else
                    <a href="{{ route('login') }}"
                        class="px-5 py-2.5 text-primary border border-primary rounded-lg hover:bg-primary hover:text-white transition font-medium">
                        Login
                    </a>
                    @if (Route::has('register'))
                    <a href="{{ route('register') }}"
                        class="px-6 py-2.5 bg-primary text-white rounded-lg hover:bg-primary-dark transition shadow-md font-medium">
                        Register
                    </a>
                    @endif
                    @endif
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t">
            <div class="px-4 py-4 space-y-3">
                ...
                <a href="{{ route('landing.keuntungan') }}"
                    class="block text-gray-700 hover:text-primary">Keuntungan</a>
                ...
                <div class="pt-4 border-t space-y-2">
                    ...
                    @endphp
                    <a href="{{ $dashboardUrl }}"
                        class="block px-4 py-2.5 text-center bg-primary text-white rounded-lg hover:bg-primary-dark transition-all shadow-md font-medium flex items-center justify-center space-x-2">
                    ...
                    @else
                    <a href="{{ route('login') }}"
                        class="block px-4 py-2.5 text-center text-primary border border-primary rounded-lg hover:bg-primary hover:text-white transition font-medium">
                        Login
                    </a>
                    @if (Route::has('register'))
                    <a href="{{ route('register') }}"
                        class="block px-4 py-2.5 text-center bg-primary text-white rounded-lg hover:bg-primary-dark transition font-medium shadow-md">
                        Register
                    </a>
                    @endif
                    @endif
    ...
    <section id="beranda" class="pt-24 pb-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden" style="background: linear-gradient(135deg, #faf9f6 0%, #ffffff 50%, #faf9f6 100%);">
        ...
        <div class="absolute top-20 right-10 w-72 h-72 bg-linear-to-br from-[#674c1d]/20 to-[#8b6f2f]/20 rounded-full filter blur-3xl animate-pulse"></div>
        <div class="absolute bottom-20 left-10 w-96 h-96 bg-linear-to-tr from-[#d4af37]/20 to-[#8b6f2f]/20 rounded-full filter blur-3xl animate-pulse" style="animation-delay: 1s;"></div>
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-linear-to-r from-[#8b6f2f]/10 to-[#d4af37]/10 rounded-full filter blur-3xl animate-pulse" style="animation-delay: 2s;"></div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
                        @if (auth()->check())
                            @php
                                ...
                                $dashboardUrl = $user->role === 'nasabah' ? route('nasabah.dashboard') : '/admin/dashboard';
                            @endphp
                            <a href="{{ $dashboardUrl }}" class="group px-8 py-4 bg-linear-to-r from-[#674c1d] via-[#8b6f2f] to-[#d4af37] text-white rounded-xl font-bold shadow-2xl hover:shadow-3xl transition-all hover:scale-105 flex items-center justify-center space-x-2">
                        ...
                        @else
                            <a href="{{ route('register') }}" class="group px-8 py-4 bg-linear-to-r from-[#674c1d] via-[#8b6f2f] to-[#d4af37] text-white rounded-xl font-bold shadow-2xl hover:shadow-3xl transition-all hover:scale-105 flex items-center justify-center space-x-2">
                ...
                <div class="relative mt-12 lg:mt-0">
                    ...
                    <div class="relative">
                        ...
                        <div class="bg-white rounded-3xl p-6 md:p-8 shadow-2xl border border-gray-100 mb-4 md:mb-6 hover:shadow-3xl transition-all duration-500">
                            <div class="grid grid-cols-3 gap-3 md:gap-6">
                                <div class="text-center">
                                    <div class="w-12 h-12 md:w-16 md:h-16 mx-auto mb-2 md:mb-3 bg-linear-to-br from-[#674c1d] to-[#8b6f2f] rounded-2xl flex items-center justify-center shadow-lg">
                                ...
                                <div class="text-center">
                                    <div class="w-12 h-12 md:w-16 md:h-16 mx-auto mb-2 md:mb-3 bg-linear-to-br from-[#d4af37] to-[#f4d03f] rounded-2xl flex items-center justify-center shadow-lg">
                                        <svg class="w-6 h-6 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="text-center">
                                    <div class="w-12 h-12 md:w-16 md:h-16 mx-auto mb-2 md:mb-3 bg-linear-to-br from-[#8b6f2f] to-[#d4af37] rounded-2xl flex items-center justify-center shadow-lg">
                                        <svg class="w-6 h-6 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="grid grid-cols-2 gap-3 md:gap-4">
                            <div class="bg-linear-to-br from-[#674c1d] to-[#8b6f2f] rounded-2xl p-4 md:p-6 text-white shadow-xl hover:shadow-2xl transition-all hover:scale-105 cursor-pointer">
                    ...
                    <!-- Decorative Elements -->
                    <div class="hidden lg:block absolute -top-6 -right-6 w-24 h-24 bg-linear-to-br from-[#d4af37] to-[#f4d03f] rounded-full opacity-20 blur-2xl animate-pulse"></div>
                    <div class="hidden lg:block absolute -bottom-6 -left-6 w-32 h-32 bg-linear-to-br from-[#674c1d] to-[#8b6f2f] rounded-full opacity-20 blur-2xl animate-pulse" style="animation-delay: 0.5s;"></div>
                </div>
            </div>
    ...
    <section id="layanan" class="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Tabungan -->
                <div
                    class="card-hover bg-white rounded-2xl p-8 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-100">
                ...
                <!-- Pinjaman -->
                <div
                    class="card-hover bg-white rounded-2xl p-8 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-200">
                    <div class="w-16 h-16 gradient-primary rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Deposito -->
                <div
                    class="card-hover bg-white rounded-2xl p-8 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-300">
                    <div class="w-16 h-16 gradient-primary rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Gadai -->
                <div
                    class="card-hover bg-white rounded-2xl p-8 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-400">
                    <div class="w-16 h-16 gradient-primary rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <section id="keuntungan" class="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-primary/5 to-accent/5">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <!-- Benefit 1 -->
                <div
                    class="card-hover bg-white rounded-2xl p-8 shadow-lg text-center fade-in-up animate-on-scroll delay-100">
                ...
                <!-- Benefit 2 -->
                <div
                    class="card-hover bg-white rounded-2xl p-8 shadow-lg text-center fade-in-up animate-on-scroll delay-200">
                    <div class="w-20 h-20 gradient-primary rounded-full flex items-center justify-center mx-auto mb-6">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                ...
                <!-- Benefit 3 -->
                <div
                    class="card-hover bg-white rounded-2xl p-8 shadow-lg text-center fade-in-up animate-on-scroll delay-300">
                    <div class="w-20 h-20 gradient-primary rounded-full flex items-center justify-center mx-auto mb-6">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                ...
                <!-- Benefit 4 -->
                <div
                    class="card-hover bg-white rounded-2xl p-8 shadow-lg text-center fade-in-up animate-on-scroll delay-400">
                    <div class="w-20 h-20 gradient-primary rounded-full flex items-center justify-center mx-auto mb-6">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <section id="testimoni" class="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Testimonial 1 -->
                <div
                    class="testimonial-card rounded-2xl p-8 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-100">
                    <div class="flex items-center mb-6">
                        <img src="{{ asset('images/logo/logo_coklat.png') }}" alt="Ahmad Rizki"
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        "Banyak keuntungan yang saya dapatkan sejak bergabung dengan Koperasi Majakara. Pelayanan yang
                        ramah, proses cepat, dan bunga yang kompetitif membuat saya sangat puas."
                    </p>
                </div>

                <!-- Testimonial 2 -->
                <div
                    class="testimonial-card rounded-2xl p-8 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-200">
                    <div class="flex items-center mb-6">
                        <img src="{{ asset('images/logo/logo_coklat.png') }}" alt="Siti Nurhaliza"
                            class="w-16 h-16 object-contain"
                            style="mix-blend-mode: multiply; filter: brightness(1.1) contrast(1.2);">
                        <div class="ml-4">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        "Proses pinjaman sangat mudah dan cepat. Saya sangat terbantu dengan layanan Koperasi Majakara
                        untuk kebutuhan usaha saya."
                    </p>
                </div>

                <!-- Testimonial 3 -->
                <div
                    class="testimonial-card rounded-2xl p-8 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-300">
                    <div class="flex items-center mb-6">
                        <img src="{{ asset('images/logo/logo_coklat.png') }}" alt="Budi Santoso"
                            class="w-16 h-16 object-contain">
                        <div class="ml-4">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        "Saya sudah menggunakan layanan deposito selama 3 tahun dan sangat puas dengan return yang
                        diberikan. Koperasi Majakara memang terpercaya!"
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="faq" class="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-primary/5 to-accent/5">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-4">
                <!-- FAQ 1 -->
                <div
                    class="faq-item bg-white rounded-xl p-6 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-100">
                    <button class="faq-toggle w-full flex justify-between items-center text-left"
                        onclick="toggleFaq(this)">
                        <span class="font-semibold text-lg text-primary">Bagaimana cara mendaftar menjadi
                            anggota?</span>
                        <svg class="w-6 h-6 text-primary transform transition-transform" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="faq-content mt-4">
                        <p class="text-gray-600 leading-relaxed">
                            Anda dapat mendaftar dengan mengunjungi kantor kami atau melalui website. Siapkan KTP, NPWP
                            (jika ada), dan dokumen pendukung lainnya. Proses pendaftaran biasanya selesai dalam 1-2
                            hari kerja.
                        </p>
                    </div>
                </div>
                ...
                <!-- FAQ 2 -->
                <div
                    class="faq-item bg-white rounded-xl p-6 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-200">
                    <button class="faq-toggle w-full flex justify-between items-center text-left"
                        onclick="toggleFaq(this)">
                        <span class="font-semibold text-lg text-primary">Berapa bunga yang diberikan untuk
                            tabungan?</span>
                        <svg class="w-6 h-6 text-primary transform transition-transform" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
                    ...
                    <div class="faq-content mt-4">
                        <p class="text-gray-600 leading-relaxed">
                            Bunga tabungan kami sangat kompetitif dan dihitung berdasarkan saldo rata-rata. Silakan
                            hubungi customer service kami untuk informasi detail mengenai suku bunga terkini.
                        </p>
                    </div>
                </div>
                ...
                <!-- FAQ 3 -->
                <div
                    class="faq-item bg-white rounded-xl p-6 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-300">
                    <button class="faq-toggle w-full flex justify-between items-center text-left"
                        onclick="toggleFaq(this)">
                        <span class="font-semibold text-lg text-primary">Apa saja syarat untuk mengajukan
                            pinjaman?</span>
                        <svg class="w-6 h-6 text-primary transform transition-transform" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
                    ...
                    <div class="faq-content mt-4">
                        <p class="text-gray-600 leading-relaxed">
                            Syarat utama adalah menjadi anggota aktif minimal 6 bulan, memiliki penghasilan tetap, dan
                            menyiapkan dokumen seperti slip gaji, KTP, dan dokumen pendukung lainnya sesuai jenis
                            pinjaman.
                        </p>
                    </div>
                </div>
                ...
                <!-- FAQ 4 -->
                <div
                    class="faq-item bg-white rounded-xl p-6 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-400">
                    <button class="faq-toggle w-full flex justify-between items-center text-left"
                        onclick="toggleFaq(this)">
                    ...
                    <div class="faq-content mt-4">
                        <p class="text-gray-600 leading-relaxed">
                            Ada biaya administrasi yang sangat terjangkau untuk berbagai layanan. Biaya ini transparan
                            dan akan diinformasikan sebelum Anda menggunakan layanan. Untuk anggota aktif, beberapa
                            biaya administrasi dapat dikurangi.
                        </p>
                    </div>
                </div>
                ...
                <!-- FAQ 5 -->
                <div
                    class="faq-item bg-white rounded-xl p-6 shadow-lg border border-gray-100 fade-in-up animate-on-scroll delay-500">
                    <button class="faq-toggle w-full flex justify-between items-center text-left"
                        onclick="toggleFaq(this)">
                        <span class="font-semibold text-lg text-primary">Bagaimana cara melakukan transaksi
                            online?</span>
                        <svg class="w-6 h-6 text-primary transform transition-transform" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
                    ...
                    <div class="faq-content mt-4">
                        <p class="text-gray-600 leading-relaxed">
                            Setelah menjadi anggota, Anda akan mendapatkan akses ke aplikasi mobile dan website. Login
                            menggunakan nomor anggota dan password yang diberikan. Semua transaksi dapat dilakukan
                            secara online 24/7.
                        </p>
                    </div>
                </div>
