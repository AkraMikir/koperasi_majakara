                                ...
                                <div class="flex items-center {{ $i < 6 ? 'flex-1' : '' }}">
                                    <div class="flex flex-col items-center progress-step {{ $subStep == $i ? 'active' : '' }}">
                                        <div class="relative">
                                            <!-- Circle with icon -->
                                            <div
                                                class="flex items-center justify-center w-12 h-12 rounded-full {{ $subStep > $i ? 'bg-linear-to-br from-green-500 to-green-600' : ($subStep == $i ? 'bg-linear-to-br from-[#674c1d] to-[#8b6f2f]' : 'bg-gray-200') }} text-white transition-all duration-300 shadow-md {{ $subStep == $i ? 'ring-4 ring-[#d4af37]/30' : '' }}">
                                                @if($subStep > $i)
                                                ...
                                                @else
                                                    ...
                                                    <svg class="w-5 h-5 {{ $subStep < $i ? 'text-gray-500' : '' }}" fill="none"
                                            ...
                                            @if($subStep >= $i)
                                                <div
                                                    class="absolute -top-1 -right-1 w-5 h-5 bg-[#d4af37] rounded-full flex items-center justify-center text-white text-xs font-bold shadow-sm">
                                                    {{ $i }}
                                                </div>
                                            @endif
                                        </div>
                                        <span
                                            class="mt-2 text-xs text-center {{ $subStep >= $i ? 'text-[#674c1d] font-semibold' : 'text-gray-500' }} max-w-[90px] leading-tight">
                                            {{ $subStepLabels[$i] }}
                                        </span>
                                    </div>
                                    @if($i < 6)
                                        ...
                                        <div class="flex-1 h-1 mx-2 rounded-full relative overflow-hidden bg-gray-200">
                                            <div
                                                class="absolute inset-0 {{ $subStep > $i ? 'bg-linear-to-r from-green-500 to-green-600' : ($subStep == $i ? 'bg-linear-to-r from-[#674c1d] to-[#8b6f2f] w-1/2' : 'w-0') }} transition-all duration-500">
                                            </div>
                                        </div>
                                    @endif
                                </div>
                            ...
                            @if($step == 1)
                                ...
                                @if($subStep == 1)
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div>
                                                <label for="foto" class="block text-sm font-medium text-gray-700 mb-2">Foto
                                                    Selfie
                                                </label>
                                                ...
                                                <div id="fotoPreview"
                                                    class="mt-2 {{ !empty($formData['foto']) && $formData['foto'] !== 'default-profile.jpg' ? '' : 'hidden' }}">
                                                    <img id="fotoPreviewImg"
                                                        src="{{ !empty($formData['foto']) && $formData['foto'] !== 'default-profile.jpg' ? asset('storage/' . $formData['foto']) : '' }}"
                                                        alt="Preview" class="h-20 w-20 rounded-lg object-cover">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                @elseif($subStep == 2)
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="space-y-4">
                                            <div>
                                                <label for="no_kk" class="block text-sm font-medium text-gray-700 mb-2">Nomor
                                                    KK</label>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div>
                                                    <label for="foto_ktp"
                                                        class="block text-sm font-medium text-gray-700 mb-2">Foto KTP
                                                    </label>
                                                    <label for="foto_ktp" class="cursor-pointer">
                                                        ...
                                                        <input type="file" name="foto_ktp" id="foto_ktp" accept="image/*"
                                                            class="hidden" onchange="previewImage(this, 'fotoKtpPreview')">
                                                    </label>
                                                    <div id="fotoKtpPreview"
                                                        class="mt-2 {{ !empty($formData['foto_ktp']) ? '' : 'hidden' }}">
                                                ...
                                                <div>
                                                    <label for="foto_kk"
                                                        class="block text-sm font-medium text-gray-700 mb-2">Foto KK
                                                    </label>
                                                    <label for="foto_kk" class="cursor-pointer">
                                                        ...
                                                        <input type="file" name="foto_kk" id="foto_kk" accept="image/*"
                                                            class="hidden" onchange="previewImage(this, 'fotoKkPreview')">
                                                    </label>
                                                    <div id="fotoKkPreview"
                                                        class="mt-2 {{ !empty($formData['foto_kk']) ? '' : 'hidden' }}">
                                        ...
                                        <div class="space-y-4">
                                            <div>
                                                ...
                                                <input type="text" name="no_rekening" id="no_rekening"
                                                    value="{{ old('no_rekening', $formData['no_rekening'] ?? '') }}"
                                                    maxlength="16"
                                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#674c1d] focus:border-[#674c1d] transition-all outline-none"
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <select name="jenis_atm" id="jenis_atm"
                                                        ...
                                                        <option value="BCA" {{ (old('jenis_atm', $formData['jenis_atm'] ?? '') == 'BCA') ? 'selected' : '' }}>
                                                            BCA</option>
                                                        <option value="Mandiri" {{ (old('jenis_atm', $formData['jenis_atm'] ?? '') == 'Mandiri') ? 'selected' : '' }}>
                                                            Mandiri</option>
                                                        <option value="BNI" {{ (old('jenis_atm', $formData['jenis_atm'] ?? '') == 'BNI') ? 'selected' : '' }}>
                                                            BNI</option>
                                                        <option value="BRI" {{ (old('jenis_atm', $formData['jenis_atm'] ?? '') == 'BRI') ? 'selected' : '' }}>
                                                            BRI</option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                @elseif($subStep == 5)
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                                            <h4 class="text-sm font-semibold text-blue-900 mb-2">📋 Petunjuk Foto KTP untuk OCR:
                                            </h4>
                                            <ul class="text-sm text-blue-800 space-y-1 list-disc list-inside">
                                                ...
                                                <li><strong>Mohon di check ulang</strong> setelah OCR jika ada data yang tidak
                                                    terprocess dengan benar</li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <label for="nama_lengkap_ktp"
                                                        class="block text-sm font-medium text-gray-700 mb-2">Nama Lengkap
                                                        (Sesuai
                                                        KTP)</label>
                                            ...
                                            <div>
                                                ...
                                                <select name="jenis_kelamin_ktp" id="jenis_kelamin_ktp"
                                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#674c1d] focus:border-[#674c1d] transition-all outline-none">
                                                    <option value="">Pilih Jenis Kelamin</option>
                                                    <option value="Laki-laki" {{ (old('jenis_kelamin_ktp', $formData['jenis_kelamin_ktp'] ?? '') == 'Laki-laki') ? 'selected' : '' }}>
                                                        Laki-laki</option>
                                                    <option value="Perempuan" {{ (old('jenis_kelamin_ktp', $formData['jenis_kelamin_ktp'] ?? '') == 'Perempuan') ? 'selected' : '' }}>
                                                        Perempuan</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div>
                                                    <label for="kel_desa"
                                                        class="block text-sm font-medium text-gray-700 mb-2">Kel/Desa</label>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <label for="darurat_foto_ktp" class="cursor-pointer">
                                                    ...
                                                    <input type="file" name="darurat_foto_ktp" id="darurat_foto_ktp"
                                                        accept="image/*" class="hidden"
                                                        onchange="previewImage(this, 'daruratKtpPreview')">
                                                </label>
                                                <div id="daruratKtpPreview"
                                                    class="mt-2 {{ !empty($formData['darurat_foto_ktp']) ? '' : 'hidden' }}">
                            ...
                            @elseif($step == 2)
                                ...
                                <div class="space-y-6">
                                    ...
                                    @if(session('error') && !session('success'))
                                        <div
                                            class="p-4 bg-red-50 border border-red-200 rounded-lg text-red-800 flex items-start gap-3 animate-shake">
