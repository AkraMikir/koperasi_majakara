                                    ...
                                    @if(!($otpSent ?? false))
                                        <div class="text-center space-y-6">
                                            ...
                                            <div class="flex justify-center">
                                                <div
                                                    class="w-24 h-24 bg-linear-to-br from-[#fdf3d0] to-[#fde8a0] rounded-full flex items-center justify-center shadow-lg animate-bounce-slow">
                                                    <svg class="w-12 h-12 text-[#8b6f2f]" fill="none" stroke="currentColor"
                                            ...
                                            <div>
                                                ...
                                                <div
                                                    class="inline-block bg-linear-to-r from-[#fdf3d0] to-[#fde8a0] border-2 border-[#d4af37] rounded-xl px-8 py-4 shadow-md">
                                                    <p class="text-xl font-bold text-[#674c1d] tracking-wide">
                                                        {{ $email ?? session('register_email') ?? 'Email tidak ditemukan' }}
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-left">
                                                ...
                                                <ul class="text-sm text-blue-700 space-y-1.5 list-none">
                                                    <li class="flex items-start gap-2">
                                                        ...
                                                        <span>Email Anda <strong>aktif</strong> dan dapat menerima pesan</span>
                                                    </li>
                                                    <li class="flex items-start gap-2">
                                                        <span class="text-blue-500 shrink-0">✓</span>
                                                        <span>Cek folder <strong>Spam/Junk</strong> jika tidak ada di inbox</span>
                                                    </li>
                                                    <li class="flex items-start gap-2">
                                                        <span class="text-blue-500 shrink-0">✓</span>
                                                        <span>Data di atas sudah <strong>benar</strong></span>
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="mt-6">
                                                <button type="button" name="send_otp_btn" value="1" id="btnSendOtp"
                                                    ...
                                                    <span id="textSendOtp">Kirim Kode OTP ke Email</span>
                                                </button>
                                            </div>
                                        ...
                                        <div class="space-y-6">
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-start gap-3">
                                                    ...
                                                    <div class="flex-1">
                                                        <p class="text-xs text-green-900 font-bold">
                                                            Kode OTP Berhasil Dikirim! 🎉
                                                        </p>
                                                        <p class="text-xs text-green-800 mt-1">
                                                            Email: <strong
                                                                class="font-semibold">{{ $email ?? session('register_email') ?? 'Email tidak ditemukan' }}</strong>
                                                        </p>
                                                        <p class="text-xs text-green-700 mt-2 flex items-center gap-1">
                                                            ...
                                                            Buka kotak masuk email Anda dan masukkan 6 digit kode OTP di bawah ini
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-start gap-3">
                                                    ...
                                                    <div class="text-xs text-blue-700">
                                                        ...
                                                        <ul class="space-y-1 list-disc list-inside">
                                                            ...
                                                            <li>Cek folder <strong>Spam/Junk</strong> di kotak masuk email Anda</li>
                        ...
                        <div class="relative z-10 text-center text-white">
                                    ...
                                    <div class="space-y-3 text-left">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="text-sm">
                                                ...
                                                <p class="text-white/70 text-xs">Via Email</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-3">
                                            <div
                            ...
                            @elseif($step == 2)
                                ...
                                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                                    ...
                                    <p class="text-sm">Periksa email Anda untuk mendapatkan kode verifikasi 6 digit</p>
                                </div>
                            @else
    ...
    function removeImage(uploadInputId, hiddenInputId, previewId) {
        ...
        function setSendOtpAndLoading(button) {
            ...
            try {
                Swal.fire({
                    title: 'Mengirim OTP...',
                    html: 'Sedang mengirim kode OTP ke Email Anda, mohon tunggu.',
